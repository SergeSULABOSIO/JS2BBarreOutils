...
public class CustomBordure implements Border{
    ...
    public CustomBordure(Bouton bouton, boolean canTracer) {
        this.insets = bouton.getBouton().getInsets();
        this.canTrace = canTracer;
    }
    ...
    public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
        ...
        if(canTrace == true){
            g.fill3DRect(0, height - insets.bottom, width, height - insets.bottom, true);
        }  //Bas
